...
- Actualizar el README raíz para reflejar la nueva topología.
...
- [x] El README raíz y este sprint reflejan el estado real. — El root README documenta Sprint 07, la persistence local-first en `core`, y el routing id-first con `buildContentUrlById` en `web`.
