...
- [ ] **JEV-004 — Expose moderation state and preference through Core APIs**
  ...
  - [ ] **JEV-004C — Batch current-source freshness for list and profile summaries**
    ...
    - Status: pending design and implementation. This is a prerequisite for current-judgment use in homepage-safe filtering.
...
- [ ] **JEV-005 — Implement disabled-by-default web enforcement path**
  ...
  - [x] **JEV-005-DEV-PREVIEW-RELEASE-GATE — Exclude the development moderation preview from production output**
    ...
    - Commit identity: `fix(web): exclude moderation preview from production routes`, `103d967`, plus this asset-exclusion correction (commit pending) on `agent/jev-moderation-preview-release-gate`.
