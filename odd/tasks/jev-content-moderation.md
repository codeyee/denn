...
- [ ] **JEV-002 — Integrate TypeSafe and compose code-owned policy**
  ...
  - [x] **JEV-002-Q3 — Use persisted type-specific text in Jev state**
    ...
    - Correction rollback: revert the correction work-unit commit to restore the previous season reconstruction behavior. Commit identity and `git show --check` result are recorded in the evidence follow-up.
