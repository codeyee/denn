...
- `<PaginationControls />` → `app/_components/common/PaginationControls.tsx`
...
├── index.tsx                    # Orchestrator (~120-150 lines)
...
**Apply this structure to all pages. See ListDetailPage for reference implementation.**
