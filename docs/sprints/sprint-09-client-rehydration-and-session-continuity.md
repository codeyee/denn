...
- Actualizar `AGENTS.md` o `web/README` con "dónde vive el bootstrap" y "cómo agregar una ruta protegida nueva".
...
- Subtareas:
  ...
  - link desde `AGENTS.md` o `web/README` para que nuevos contribuidores no repitan el bug.
...
- [ ] `AGENTS.md` o `web/README` referencia la política.
