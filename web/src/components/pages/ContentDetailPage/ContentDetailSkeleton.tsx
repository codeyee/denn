    ...
    >
      <div className="pb-20 pt-30">
        <section className="-mt-30 mb-6 md:mb-10 relative z-0">
          <div className={`layout-banner relative overflow-hidden bg-white/5 md:rounded-2xl ${COMPACT_BANNER_SIZE}`}>
            ...
            <div className="absolute inset-x-0 bottom-8 md:bottom-10">
              <div className="layout-banner-content space-y-4">
        ...
        <section className="mb-10">
          <div className="layout-content mt-8 space-y-3">
        ...
        <section className="mb-10">
          <div className="layout-content space-y-4">
